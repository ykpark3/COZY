...
import com.example.myeyes.UI.AdrressDialog;
import com.example.myeyes.UI.DeleteAdrressDialog;
import com.example.myeyes.UI.MovingLineDialog;
        ...
        buttonClickInMovingLine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //확진자 동선 정보 보기 다이얼로그
                    ...
                    url[0] = Constant.CORONA_MOVING_LINE_URL;
                    url[1] = String.valueOf(43);
                    url[2] = String.valueOf(latitudeLogitude[0]);
                    url[3] = String.valueOf(latitudeLogitude[1]);
